...
IL_0037:
	{
		...
		L_10 = GetRayIntersectionAllCallback_Invoke_m917AA4108EBDC724AFEF39BFD06A586B7461F497(L_6, L_7, L_8, L_9, NULL);
...
IL_0097:
	{
		...
		NullCheck(L_20);
		int32_t L_25;
		L_25 = GetRayIntersectionAllNonAllocCallback_Invoke_mFAA36E9AF362DC72204EEF53B28DBFC3367D09A7(L_20, L_21, L_22, L_23, L_24, NULL);
		V_3 = L_25;
	}
...
IL_0118:
	{
		...
		(&V_9)->___index_3 = ((float)((float)L_65));
...
IL_006c:
	...
	}
	{
		...
		float L_37 = V_1;
		float L_38;
		L_38 = fabsf(((float)((float)((float)il2cpp_codegen_subtract((float)L_34, (float)L_36))/(float)L_37)));
		G_B11_0 = L_38;
		G_B11_1 = G_B9_0;
		goto IL_00be;
	}
...
IL_0037:
	{
		...
		L_10 = RaycastAllCallback_Invoke_mB30319766AF5F0D5145A6C0AFFEA829A31A5D4B7(L_6, L_7, L_8, L_9, NULL);
...
IL_0097:
	{
		...
		NullCheck(L_20);
		int32_t L_25;
		L_25 = GetRaycastNonAllocCallback_Invoke_m36411365E9622819DAB93D0BB0F169FEE99F07D9(L_20, L_21, L_22, L_23, L_24, NULL);
		V_3 = L_25;
	}
...
IL_00dc:
	{
		...
		(&V_7)->___index_3 = ((float)((float)L_49));
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void RaycastHitComparer__cctor_m2AF7BB0B25461CCA9CA4C8EE799439478D18E1D3 (const RuntimeMethod* method)
{
	...
	}
	{
		...
		RaycastHitComparer__ctor_mAB0536EE515BF2BD1B29BE3B39E8BA9E9CFE97C3(L_0, /*hidden argument*/NULL);
